...
\textbf{Generating only the used built-ins}\\
Currently the HCL compiler generates the entire suite of built-in functions, for every compiled program.
An optimization, mostly in terms of used disk-space however little, would be to only generate built-ins, if they appeared in the HCL code.
