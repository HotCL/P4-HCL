...
func jIsGreaterThan1 = () : bool { j greaterThan 1 }
...
In snippet \ref{lis:ConclusionWhile}, lines 1 to 3 consists of declarations, line 8 consists of the function-call to \textit{\textbf{while}}.
The While function takes two Lambda expressions as arguments, in this case two function pointers.
...
\subsection{Conclusion on the solution} %Shit rhymes
...
Third, a codegenerator which traverses the AST and generates C++ code.
