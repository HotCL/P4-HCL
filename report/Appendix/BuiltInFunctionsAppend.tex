...
\begin{table}[h!]
	...
	\begin{tabular}{|c|c|c|c|}
		\hline
		\textbf{Operation}                                                       & \textbf{Symbol}         & \textbf{Input Parameters} & \textbf{Return Type} \\ \hline
		Less Than                                                    & lessThan          & num, num         & bool        \\ \hline
		\begin{tabular}[c]{@{}c@{}}Less Than \\ Equals\end{tabular}  & lessThanEqual     & num, num         & bool        \\ \hline
		Greater Than                                                    & greaterThan       & num, num         & bool        \\ \hline
		\begin{tabular}[c]{@{}c@{}}Greater Than \\ Equals\end{tabular}  & greaterThanEqual  & num, num         & bool        \\ \hline
		...
		Boolean Equals                                                  & equals            & bool, bool       & bool        \\ \hline
		\begin{tabular}[c]{@{}c@{}}Boolean Not \\ Equals\end{tabular}   & notEquals         & bool, bool       & bool        \\ \hline
...
\begin{table}[h!]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		Sub Text           & splitAt & txt, num, num    & txt         \\ \hline
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		Foreach Loop                                              & forEach   & list{[}T{]}, func{[}none{]} & none        \\ \hline
	\end{tabular}
\end{table}
