...
The \texttt{setup} and \texttt{loop} functions are wrapped to function correctly on the Arduino platform, and calls to the functions are automatically added to the file's \texttt{main} function. 
