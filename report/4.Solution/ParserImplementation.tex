...
As seen in snippet \ref{lis:parsePotCall}, the parser will determine whether or not the expression is a functioncall by trying to determine if the current token is an argument for a function, or if it is a value by itself.
