...
%Tobias' forslag til en mere detaljeret forklaring af sætningen på linje 19:
%However, in the HCL compiler type checking happens within the parser.
%This is because of two reasons.
%Firstly, because the language only allows predefined types.
%Secondly, because it is impossible to determine which arguments should be grouped with which function calls without prior knowledge of the function declaration.
