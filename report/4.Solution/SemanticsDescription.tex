...
%...
$S ::= x = e | S_1;S_2 | b\ then\ L | L\ while\ b | list\ forEach\ L | p | eOrL\ p\ eOrL^* | Fcall | D_V | D_P | \epsilon$\\
%...
...
The transitions are shown below.
The reader should note that, since HCL is utilizing fully static scope rules, transitions for function calls needs more components to successfully enable recursive calling of function.
