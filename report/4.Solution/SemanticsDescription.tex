...
The transition-system for $list_{exp}$ is $(list_{exp} \cup List, \rightarrow_{list}, List)$.
The single transition not yet handled is shown below.

\textbf{[$ListLit_{BSS}$]}\\
\begin{center}
	\begin{math}
	env_V,\ sto \vdash lst \rightarrow_b v
	\end{math}
...
\begin{center}
	\begin{math}
	env_V,\ sto \vdash tpl \rightarrow_b v
	\end{math}
