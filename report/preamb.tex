...
\lstdefinelanguage{HCL}
{
	...
	ndkeywordstyle=\color{BurntOrange}\bfseries,
	emph={map, filter, reduce, print, add, where, do, equals, then, else, thenElse, +, -, /, *, not, addNumbers, is, modifyNumber, modifyFunction, times2, isAwesome, onEach, each, mapFunction, SetLEDPower, delay, LedSetup}, %add all included functions here
