...
\usepackage[usenames,dvipsnames]{xcolor}				% Definer farver med \definecolor. Se mere: http://en.wikibooks.org/wiki/LaTeX/Colors had to move up due to optionclash with pgf
...
\lstdefinelanguage{HCL}
{
	...
	ndkeywords={txt, num, bool, tuple, list, func},
	ndkeywordstyle=\color{BurntOrange}\bfseries,
	emph={map, filter, reduce, print, add}, %add all included functions here
