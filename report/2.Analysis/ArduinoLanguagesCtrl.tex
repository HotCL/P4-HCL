...
Before doing any work on HCL, the project group has decided to research how many high-level languages already exist for the Arduino platform, and what distinguishes them from each other.
