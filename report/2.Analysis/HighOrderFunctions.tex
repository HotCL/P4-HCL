...
The major benefit from the high-order functions is the ability to create abstract functions, that will have its behaviour defined through the input function. 
...
Although some of the use cases of high-order functions may be a bit too complex for the new users, who are the target group of HCL, the high-order functions are still valued an important feature.
This is due to serveral reasons.
