...
Because of the fact that the category have rewriting rules for declarations, this means that statements can also both change the variable environment $Env_V$ and the function environment $Env_F$.
...
\texttt{[$StmDlcF_{BSS}$]}\\
\begin{center}
	$\langle D_V, env_F, sto \rangle \rightarrow_{D_V} (env_F', sto')$
\end{center}
