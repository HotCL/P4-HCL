...
$F_{call}\ ::=\ pOrf\ |\ eOrL\ f\ eOrL^*$\\
$L\ ::= \{\ S\ \}\ |\ \{\ S\ return\ e\ \}\ |\ \{\ S;\ e\ \}$\\
$S\ ::=\ x\ =\ e\ |\ S_1;S_2\ |\ b\ then\ L\ |\ L\ while\ b\ |\ F_{call} |\ D_V\ |\ D_P\ |\ \epsilon$\\
...
\begin{center}
	...
	{env_v, sto \vdash x\ f\ x\sim \rightarrow_{stm} v, sto'}
	\end{math}
...
\begin{center}
	\begin{math}
		\cfrac
			{env_V, env_P \vdash \langle S, sto \rangle \rightarrow_L sto' \quad env_V, sto', e \rightarrow_e v}
