...
Because the category has rewriting rules for declarations, statements can change both the variable environment $Env_V$ and the function environment $Env_F$.
