...
In theory this problem could be solved with overloading. However, this would require an overloading of a lot of functions with all the possible types within HCL. 
Since tuples are distinguished by the types within it, there are an infinite amount of types within HCL, which in turn makes overloading for this case impossible.
