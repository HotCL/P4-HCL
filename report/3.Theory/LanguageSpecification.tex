...
The return statement is noticeably missing in the first funciton.
...
To declare that a function will accept other functions, that the developer should simply declare a parameter of type "func" with the expected input and output types from the function.
