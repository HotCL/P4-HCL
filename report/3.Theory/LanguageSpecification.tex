...
To declare that a function will accept other functions you should simply declare a parameter of type "func" with the expected input and output types from the function.
