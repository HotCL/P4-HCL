...
Since nothing type specific ever happens with these types, they can all be handles the same way, whether that be a string, a number or some other type will not matter.
