...
This can be amended by structuring calculations in a left-to-right manner, or by encapsulating operations with parentheses, since parentheses have higher precedence than operators.
...
\begin{lstlisting}[language=HCL,caption={Implicit type declarations in HCL, here id is short for identifier.
},firstnumber=1]
var id1 = 3141596
var id2 = 2718281
var id3 = id1 > id2
...
var id5 = (num id6, num id7): { id6 * id7}
