...
// Built in function for <(num leftHand, num rightHand) ->bool
inline bool IDT_0x3c (double leftHand, double rightHand) {
    return leftHand < rightHand;
}

// Built in function for >(num leftHand, num rightHand) ->bool
inline bool IDT_0x3e (double leftHand, double rightHand) {
    return leftHand > rightHand;
}
