...
infix fun AstNode.Command.Expression.LambdaExpression.andBody(body: AstNode.Command.Expression.LambdaBody) =
        copy(body = body)
infix fun AstNode.Command.Expression.LambdaExpression.andBody(body: AstNode.Command) =
        copy(body = body(body))
infix fun AstNode.Command.Expression.LambdaExpression.withBody(body: AstNode.Command.Expression.LambdaBody) =
        copy(body = body)
infix fun AstNode.Command.Expression.LambdaExpression.withBody(body: AstNode.Command) =
        copy(body = body(body))
