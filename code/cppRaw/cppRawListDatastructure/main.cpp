...
List<List<int>> get_list_of_lists() {
    auto l1 = get_list_1();
    auto l2 = get_list_2();
    List<int> l3_elements[] = {l1, l2};
    auto l3 = ConstList<List<int>>::create_from_copy(l3_elements, 2);
    return l3;
}

template <typename T>
inline List<T> returnListSelf(List<T> list) {
    return list;
}
